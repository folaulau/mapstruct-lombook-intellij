package com.mapstruct.lombook.intellij;
...
public class MapstructLombookIntellijApplication {

    public static void main(String[] args) {
        SpringApplication.run(MapstructLombookIntellijApplication.class, args);
    }
    ...
    public CommandLineRunner commandLineRunner(ApplicationContext ctx) {
        return args -> {
            ...
            try {
                ...
                System.out.println("************************ Mapstruct - Lombook ***********************************");
